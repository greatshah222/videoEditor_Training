...
export const subDuration = (durationA, durationB) => {
...
export const addDuration = (durationA, durationB) => {
  let { durA, durB } = regexExpressionCheck(durationA, durationB);
...
export const isVaidDuration = (text) => {
...
export const middleOfDuration = (start, end) => {
